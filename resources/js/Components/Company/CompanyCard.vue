    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      <div class="h-40 bg-gray-200 relative">
        ...
        <div class="absolute -bottom-10 left-6">
          <div class="w-20 h-20 rounded-lg bg-white shadow-md flex items-center justify-center overflow-hidden">
            <img
      ...
      <div class="p-6 pt-12">
        <!-- Nombre y sector -->
        <h3 class="text-xl font-bold text-gray-800 mb-1">{{ company.company_name }}</h3>
        ...
        <!-- Ubicación -->
        <p v-if="company.location" class="text-sm text-gray-600 mb-3 flex items-center">
