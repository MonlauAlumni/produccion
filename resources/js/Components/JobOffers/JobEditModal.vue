          ...
          <div class="flex border-b mb-6">
            <button 
              ...
              :class="[
                ...
                activeTab === 'basic' 
                  ? 'border-b-2 border-[#193CB8] text-[#193CB8]' 
          ...
          <form @submit.prevent="submit">
            ...
            <div v-if="activeTab === 'basic'" class="space-y-4">
              <div>
                ...
                <input 
                  ...
                  type="text" 
                  required
                  class="block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-[#193CB8] focus:border-[#193CB8]"
                >
              </div>
            ...
            <div v-if="activeTab === 'details'" class="space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label for="edit-vacancies" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                  <label for="edit-work-mode" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                  <label for="edit-job-type" class="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label for="edit-min-salary" class="block text-sm font-medium text-gray-700 mb-1">
                    Salario Mínimo
                  </label>
                  <input 
                    id="edit-min-salary" 
                ...
                <div>
                  <label for="edit-max-salary" class="block text-sm font-medium text-gray-700 mb-1">
                    Salario Máximo
                  </label>
                  <input 
                    id="edit-max-salary" 
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <div class="space-y-2 mb-4">
                    <div v-for="(responsibility, index) in form.responsibilities" :key="index"
                      class="flex items-center bg-white p-2 rounded-lg border border-gray-200">
                  ...
                  <div class="flex">
                    <input v-model="newResponsibility" @keyup.enter="addResponsibility" type="text"
                      ...
                      class="flex-1 px-4 py-2 border border-gray-300 rounded-l-lg focus:ring-[#193CB8] focus:border-[#193CB8]">
                    <button type="button" @click="addResponsibility"
                      class="bg-[#193CB8] text-white px-4 py-2 rounded-r-lg">
            ...
            <div v-if="activeTab === 'requirements'" class="space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label for="edit-min-experience" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                  <label for="edit-min-studies" class="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div>
                <label for="edit-requirements" class="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div>
                <label for="edit-experience" class="block text-sm font-medium text-gray-700 mb-1">
              ...
              <!-- Skills Section - Updated to match CreateJobOffer -->
              <div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4">
                  ...
                  <div class="flex flex-wrap gap-2 mb-4">
                    ...
                    <span v-if="form.skills.length === 0" class="text-gray-500">
            ...
            <div class="mt-6 flex justify-end gap-3">
              ...
              <button 
                type="submit"
                class="px-4 py-2 bg-[#193CB8] text-white rounded-lg hover:bg-[#142d8c] flex items-center"
