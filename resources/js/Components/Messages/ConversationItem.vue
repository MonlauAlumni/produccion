  ...
  >
    <div class="flex items-start gap-3">
      ...
      <div class="relative">
        ...
        />
        <div v-else class="w-12 h-12 bg-gray-200 rounded-lg flex items-center justify-center text-[#193CB8]">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div 
          ...
          class="mt-1 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800"
        >
      ...
      <div 
        ...
        class="min-w-[20px] h-5 rounded-full bg-[#193CB8] text-white text-xs flex items-center justify-center px-1.5"
      >
