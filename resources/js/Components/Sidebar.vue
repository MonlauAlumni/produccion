  ...
  <div>
    ...
    <aside :class="[
        ...
        <div class="flex items-center space-x-3 mb-3">
          <div class="relative">
            <div v-if="user.company">
              ...
              <img v-if="user.company.profile_picture" :src="user.company.profile_picture" alt="Profile picture"
                class="w-12 h-12 object-cover shadow-sm border-2 border-white">
              <div v-else
                class="w-12 h-12 bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-[#193CB8] dark:text-blue-400 shadow-sm border-2 border-white dark:border-gray-700">
                <i class='bx bxs-building text-xl'></i>
              </div>
            </div>
            <div v-if="user.profile">
              <img v-if="user.profile.profile_picture" :src="user.profile.profile_picture" alt="Profile picture"
                class="w-12 h-12 rounded-full  shadow-sm border-2 border-white">
              <div v-else
            ...
            <div v-if="user?.company"
              class="absolute bottom-0 right-0 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-white dark:border-gray-700">
            </div>
          </div>
          <div>
      ...
      <div class="flex-1 overflow-y-auto">
        <!-- Sección principal -->
        <div class="p-4">
          <p class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2 px-2">Principal
          </p>
          <nav>
            <ul class="space-y-1">
        ...
        <div class="p-4 border-t border-gray-100 dark:border-gray-800">
          <p class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2 px-2">Social
          </p>
          <nav>
            <ul class="space-y-1">
