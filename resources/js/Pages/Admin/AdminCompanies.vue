    ...
    <AdminLayout title="Gestión de Empresas">
        ...
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-xl shadow-sm p-8 mb-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Gestión de Empresas</h1>
                ...
                <nav class="inline-flex items-center rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="flex">
                        <button v-for="pageNum in paginationRange" :key="pageNum"
                            ...
                            :class="{
                                'bg-gray-800 dark:bg-gray-700 text-white': pageNum === page.props.pagination.current_page,
                                'text-gray-500 dark:text-gray-400 cursor-not-allowed': pageNum === '...',
                                'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 border-r border-gray-200 dark:border-gray-700': pageNum !== '...' && pageNum !== page.props.pagination.current_page
                            }" 
                            :disabled="pageNum === '...'">
                            {{ pageNum }}
                        </button>
