    ...
    <div v-if="isOpen" 
      ...
      <transition name="slide-up">
        <div v-if="isOpen" 
          ...
          <div class="relative">
            <!-- Banner decorativo -->
            <div class="h-16 bg-gradient-to-r from-[#193CB8] to-[#2748c6] dark:from-[#142d8c] dark:to-[#1e3a9e] relative overflow-hidden">
          ...
          <div class="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 w-full">
            <div class="flex overflow-x-auto hide-scrollbar w-full">
              <button 
                ...
                :class="[
                  ...
                  activeTab === 'basic' 
                    ? 'border-[#193CB8] text-[#193CB8] dark:border-blue-400 dark:text-blue-400' 
          ...
          <transition name="fade">
            <div v-if="successMessage" class="absolute top-16 inset-x-0 bg-green-100 dark:bg-green-900 border-b border-green-400 dark:border-green-700 text-green-700 dark:text-green-200 px-4 py-3 flex items-center justify-between">
              <span class="flex items-center">
                <i class='bx bx-check-circle mr-2 text-xl'></i>
                {{ successMessage }}
              </span>
              <button @click="successMessage = ''" class="text-green-700 dark:text-green-200">
                <i class='bx bx-x'></i>
              </button>
            </div>
          </transition>
          ...
          <transition name="fade">
            <div v-if="errorMessage" class="absolute top-16 inset-x-0 bg-red-100 dark:bg-red-900 border-b border-red-400 dark:border-red-700 text-red-700 dark:text-red-200 px-4 py-3 flex items-center justify-between">
              <span class="flex items-center">
                <i class='bx bx-error-circle mr-2 text-xl'></i>
                {{ errorMessage }}
              </span>
              <button @click="errorMessage = ''" class="text-red-700 dark:text-red-200">
                <i class='bx bx-x'></i>
              </button>
            </div>
          </transition>
          ...
          <div class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-800">
            ...
            <form @submit.prevent="saveChanges" class="space-y-6">
              ...
              <div v-show="activeTab === 'basic'">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="group md:col-span-2">
                    ...
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                        <i class='bx bx-building'></i>
                      </div>
                      <input 
                        v-model="form.company_name" 
                        type="text" 
                        class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#193CB8] dark:focus:ring-blue-500 focus:border-[#193CB8] dark:focus:border-blue-500 transition-all bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div class="group">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                      Industria/Sector <span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                      ...
                      <select 
                        v-model="form.sector" 
                        class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#193CB8] dark:focus:ring-blue-500 focus:border-[#193CB8] dark:focus:border-blue-500 transition-all appearance-none bg-no-repeat bg-[right_0.5rem_center] bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200"
                  ...
                  <div class="group">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                      Ubicación <span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
              ...
              <div v-show="activeTab === 'description'">
                <div class="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 mb-6 border border-blue-100 dark:border-blue-800 flex items-start gap-3">
                  <i class='bx bx-bulb text-[#193CB8] dark:text-blue-400 text-xl mt-0.5'></i>
                ...
                <div class="relative">
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Descripción de la empresa</label>
                  <textarea 
                    v-model="form.description" 
                    rows="12" 
                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#193CB8] dark:focus:ring-blue-500 focus:border-[#193CB8] dark:focus:border-blue-500 transition-all bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200"
              ...
              <div v-show="activeTab === 'social'">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="group">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400 flex items-center gap-1">
                      <i class='bx bxl-linkedin text-[#193CB8] dark:text-blue-400'></i>
                      LinkedIn
                    </label>
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                  ...
                  <div class="group">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400 flex items-center gap-1">
                      <i class='bx bxl-facebook text-[#193CB8] dark:text-blue-400'></i>
                      Facebook
                    </label>
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                  ...
                  <div class="group">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400 flex items-center gap-1">
                      <i class='bx bxl-instagram text-[#193CB8] dark:text-blue-400'></i>
                      Instagram
                    </label>
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                  ...
                  <div class="group">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400 flex items-center gap-1">
                      <i class='bx bxl-twitter text-[#193CB8] dark:text-blue-400'></i>
                      Twitter
                    </label>
                    <div class="relative">
                      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#193CB8] dark:group-focus-within:text-blue-400">
                ...
                <div class="mt-6 bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 border border-blue-100 dark:border-blue-800">
                  <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                    <i class='bx bx-bulb text-[#193CB8] dark:text-blue-400'></i>
                    Consejo
                  </h3>
              ...
              <div v-show="activeTab === 'tags'">
                ...
                <div class="flex flex-wrap gap-2 mb-4 min-h-[100px] p-4 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                  <div 
                    v-for="(tag, index) in form.tags" 
                    :key="index" 
                    class="bg-blue-50 dark:bg-blue-900 text-[#193CB8] dark:text-blue-200 px-3 py-1.5 rounded-full text-sm flex items-center gap-1 transition-all hover:bg-blue-100 dark:hover:bg-blue-800"
                  >
                    ...
                    <button 
                      ...
                      class="ml-1 text-[#193CB8] dark:text-blue-200 hover:text-red-500 dark:hover:text-red-400 transition-colors"
                    >
                      <i class='bx bx-x'></i>
                    </button>
                  </div>
                  
                  <div v-if="!form.tags || form.tags.length === 0" class="w-full h-full flex items-center justify-center text-gray-400 dark:text-gray-500 text-sm">
                ...
                <div class="flex gap-2">
                  ...
                  <button 
                    type="button"
                    @click="addTag" 
                    class="bg-[#193CB8] dark:bg-blue-700 hover:bg-[#2748c6] dark:hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors flex items-center gap-1"
                  >
                ...
                <div class="mt-6 p-4 border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700">
                  <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Tags sugeridos para tu sector</h3>
                  <div class="flex flex-wrap gap-2">
                    <button 
                      ...
                      class="bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 px-3 py-1 rounded-full text-sm border border-gray-200 dark:border-gray-600 hover:border-[#193CB8] dark:hover:border-blue-500 hover:text-[#193CB8] dark:hover:text-blue-400 transition-colors"
                    >
                      {{ tag }}
                    </button>
                  </div>
          ...
          <div class="bg-gray-50 dark:bg-gray-700 p-6 border-t border-gray-200 dark:border-gray-600">
            <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-3">
              <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                <i class='bx bx-info-circle mr-1'></i>
                <span>Los campos marcados con <span class="text-red-500 dark:text-red-400">*</span> son obligatorios</span>
              </div>
                ...
                <button 
                  ...
                  :class="[
                    ...
                    isFormValid && !isLoading 
                      ? 'bg-[#193CB8] dark:bg-blue-700 hover:bg-[#2748c6] dark:hover:bg-blue-600' 
