      ...
      <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <i class='bx bx-search absolute right-3 top-2.5 mt-1 text-gray-400'></i>
              </div>
            </div>
            ...
            <div>
              ...
              <select
                ...
                class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-[#193CB8] focus:border-[#193CB8] focus:outline-none"
              >
        ...
        <div v-if="isLoading" class="flex justify-center my-8">
          <div class="animate-pulse flex space-x-2">
            <div class="w-3 h-3 bg-[#193CB8] rounded-full"></div>
            <div class="w-3 h-3 bg-[#193CB8] rounded-full animation-delay-200"></div>
            <div class="w-3 h-3 bg-[#193CB8] rounded-full animation-delay-400"></div>
          </div>
        </div>
            ...
            <nav class="flex items-center space-x-1">
              ...
              <template v-for="page in companies.links" :key="page.label">
                ...
                <button 
                  v-else-if="!page.url"
                  disabled
                  class="px-3 py-2 text-gray-400 cursor-not-allowed rounded-md text-sm font-medium"
                >
                  {{ page.label }}
                </button>
                <button 
