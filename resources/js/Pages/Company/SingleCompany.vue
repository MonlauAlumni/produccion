              ...
              <div class="space-y-6">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-gray-700">{{ company.company_phone || 'No disponible' }}</p>
                      </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  <div class="flex justify-center gap-4">
                    ...
                    <a :href="company.linkedin" class="bg-blue-50 flex hover:bg-blue-100 p-2 rounded-full transition-colors">
                      
                      <i class='bx bxl-linkedin text-[#193CB8] text-2xl'></i>
                    </a>
                  </div>
                    <div class="flex items-center justify-center">
                    <a :href="company.twitter" class="bg-blue-50 flex hover:bg-blue-100 p-2 rounded-full transition-colors">
                      <i class='bx bxl-twitter text-[#193CB8] text-2xl'></i>
                    </a>
                  </div>
                    <div class="items-center flex justify-center">
                    <a :href="company.facebook" class="bg-blue-50 hover:bg-blue-100 flex p-2 rounded-full transition-colors">
                      <i class='bx bxl-facebook text-[#193CB8] text-2xl'></i>
                    </a>
                  </div>
                    <div class="flex items-center">
                    <a :href="company.instagram" class="bg-blue-50 hover:bg-blue-100 flex items-center p-2 rounded-full transition-colors">
                      <i class='bx bxl-instagram text-[#193CB8] text-2xl '></i>
                    </a>
                  </div>
                  </div>
                </div>
