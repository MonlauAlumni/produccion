<script setup>
  ...
  const featuredCategories = [
    ...
    { id: 'design', name: 'Automoción', icon: 'bx-car', color: '#FF7C43' },
...
<template>
  <Layout>
    <div class="min-h-screen bg-gray-50 flex flex-col">
      <!-- Hero Section -->
      <div class="bg-[#193CB8] text-white py-8 px-4">
              ...
              <div class="relative max-w-xl">
                <div class="flex">
                  <input v-model="searchQuery" type="text" placeholder="Buscar por título, empresa o ubicación..."
                    class="w-full px-4 py-3 rounded-l-lg ring-2 ring-blue-100 text-black placeholder-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-300"
                    @keyup.enter="searchJobs" />

                  <button @click="searchJobs"
                    class="bg-[#193CB8] hover:bg-[#142d8c] px-4 py-3 rounded-r-lg border-2 border-white flex items-center justify-center transition-colors">
        ...
        <div class="max-w-6xl mx-auto px-4">
          <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1">
              ...
              <!-- Feed Items -->
              <div class="space-y-6">
                <JobCard v-for="job in jobOffersList" :key="job.id" :jobOffer="job" :isLiked="likedJobs.has(job.id)"
                  :isSaved="savedJobs.has(job.id)" class="job-card" @view="viewJobOffer" @apply="applyToJob"
                  @save="toggleSaveJob" @like="toggleLikeJob" @share="shareJob" />
