<script setup>
    ...
    const formatApplicationStatus = (status) => {
      const statusMap = {
        ...
        'in_process': { text: 'En proceso', class: 'bg-blue-100 text-blue-800' },
              ...
              <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1">
                  ...
                  <div v-if="activeTab === 'applied'" class="space-y-6">
                    ...
                    <div v-for="application in appliedJobsList" :key="application.id" class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                      <div class="border-b border-gray-100 px-5 py-3 flex items-center justify-between bg-gray-50">
                        <div class="flex items-center">
                          <span :class="[
                            'px-3 py-1 rounded-full text-xs font-medium flex items-center',
                            formatApplicationStatus(application.status).class
                          ]">
                          ...
                          <span class="text-gray-500 text-sm ml-3">
                            ...
                            Aplicada el {{ new Date(application.created_at).toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' }) }}
                          </span>
                        </div>
                      ...
                      <div v-if="application.cover_letter" class="px-5 py-4 border-t border-gray-100 bg-gray-50">
