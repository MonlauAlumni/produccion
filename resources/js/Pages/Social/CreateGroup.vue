            ...
            <div class="flex-1 py-8">
                <div class="max-w-4xl mx-auto px-4">
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        <div class="p-6">
                            <h2 class="text-xl font-bold text-gray-800 mb-6">Información del grupo</h2>
                            ...
                            <form @submit.prevent="submitForm" class="space-y-6">
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <label class="inline-flex items-center cursor-pointer">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-gray-500 text-sm">Cualquier persona puede ver y unirse al
                                                    grupo</p>
                                            </div>
                                        </label>
                                        <label class="inline-flex items-center cursor-pointer">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-gray-500 text-sm">Solo miembros invitados pueden unirse
                                                    al grupo</p>
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Añade etiquetas para ayudar a otros a
                                        encontrar tu grupo</p>
                                ...
                                <div>
                                    ...
                                    <div v-if="!logoPreview"
                                        ...
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 mb-4">Añade un logo para tu grupo</p>
                                            <label
                                            ...
                                            <p class="text-xs text-gray-500 mt-2">PNG, JPG o GIF (máx. 2MB)</p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div v-if="!bannerPreview"
                                        ...
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-xs text-gray-500 mt-2">PNG, JPG o GIF (máx. 2MB)</p>
                                            <p class="text-xs text-gray-500 mt-1">Tamaño recomendado: 1200 x 375 píxeles</p>
                                        </div>
                                    </div>
                                ...
                                <div v-if="form.name || logoPreview || bannerPreview" class="border border-gray-200 rounded-xl overflow-hidden">
                                    <div class="bg-gray-50 p-4 border-b border-gray-200">
                                        <h3 class="font-bold text-gray-800">Vista previa del grupo</h3>
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="h-48 bg-gradient-to-r from-[#193CB8]/20 to-[#2748c6]/20 relative">
                                            ...
                                            <div class="absolute left-6 -bottom-12">
                                                <div class="w-24 h-24 rounded-xl overflow-hidden border-4 border-white bg-white">
                                                    <img 
                                                        v-if="logoPreview" 
                                                        :src="logoPreview" 
                                                        alt="Logo del grupo" 
                                        ...
                                        <div class="pt-16 px-6 pb-6">
                                            <h2 class="text-2xl font-bold text-gray-800">{{ form.name || 'Nombre del grupo' }}</h2>
                                            ...
                                            <p class="text-gray-600 mt-4">{{ form.description || 'Descripción del grupo...' }}</p>
                    ...
                    <div class="bg-[#193CB8]/5 rounded-xl p-6 mt-6">
                        <h3 class="text-lg font-bold text-gray-800 mb-3 flex items-center">
                            <i class='bx bx-bulb text-[#193CB8] mr-2'></i> Consejos para crear un grupo exitoso
                        </h3>
